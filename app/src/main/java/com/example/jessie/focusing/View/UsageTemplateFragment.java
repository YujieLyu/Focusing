...
import static com.example.jessie.focusing.Utils.ChartUtils.STATS_DAYS;
import static com.example.jessie.focusing.Utils.ChartUtils.initBarChart;
import static com.example.jessie.focusing.View.LogDetailActivity.KEY;
...
public abstract class UsageTemplateFragment extends Fragment {
    ...
    private List<BarEntry> openTimes;
    ...
    private void initData() {
        ...
        for (int i = 0; i < STATS_DAYS; i++) {
            AppUsage appUsage = usageManager.getAppOpenTimeOfDay(packageName, STATS_DAYS - 1 - i);
